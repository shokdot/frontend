...
function Toggle({
  ...
  return (
    ...
    >
      <span
        className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-[#fff] shadow-lg transition-transform duration-200 ${
...
function TabButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-left text-sm font-medium transition-all ${
        isActive
...
export default function SettingsPage() {
  ...
  async function handleSave() {
    setIsSaving(true);
    // TODO: wire to API — PATCH /api/v1/users/me/settings
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <button className="rounded-lg bg-accent/10 px-3 py-1.5 text-sm font-medium text-accent-light transition-colors hover:bg-accent/20">
                          Change avatar
                        </button>
                    ...
                    {/* Email */}
                    <div>
                      <label htmlFor="s-email" className="mb-1.5 block text-sm font-medium text-zinc-300">
                        Email
                      </label>
                      <input
                        id="s-email"
